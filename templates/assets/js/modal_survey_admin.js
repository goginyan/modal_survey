(function( jQuery ){
	...
	var rmdni = false, exportcharts = 2, thisexpelement = '', actionfl = false,	survey_id, lastScrollTop = 0, surveysystem = jQuery.noConflict(), buttonspan_global = "", active_survey, random, played_question = 0, delprsurv = "", exporttimer, ziptimer, msChartData = {}, labs = [], dset = [], msChartBGcolor = [], msChartBGcolor2 = [], handler = 0;
	...
	function play_survey() {
		...
		var thiscount = surveysystem("#"+survey_id+" #"+thisquestion+" div span#answer_count"+(index2+1)).text().split(" - ");
			...
			ao[ ( index + 1 ) + "_" + ( index2 + 1 ) ] = [answer_type, answer_unique, autocomplete, imageurl, score, correct, imgwidth, imgheight,answer_status, converttextarea, surveysystem( this ).parent().find( ".ao-accordion .answer_tooltip_text" ).val(), surveysystem( this ).parent().find( ".ao-accordion .answer_redirection" ).val(), surveysystem( this ).parent().find( ".ao-accordion .answer_category" ).val(), hidelabel, surveysystem( this ).parent().find( ".ao-accordion .answer_comment_text" ).val()];
			})
		...
		if ( rmdni == false ) {
			...
			if ( error == false ) {
				...
				surveysystem( "#"+survey_id+" .question_text" ).each(function( index ) {
					...
					ao[ ( index + 1 ) + "_" + ( index2 + 1 ) ] = [ answer_type, answer_unique, autocomplete, imageurl, score, correct, imgwidth, imgheight, answer_status, converttextarea, surveysystem( this ).parent().find( ".ao-accordion .answer_tooltip_text" ).val(), surveysystem( this ).parent().find( ".ao-accordion .answer_redirection" ).val(), surveysystem( this ).parent().find( ".ao-accordion .answer_category" ).val(), hidelabel, surveysystem( this ).parent().find( ".ao-accordion .img-align:checked" ).val(), surveysystem( this ).parent().find( ".ao-accordion .answer_tooltip_text" ).val(), surveysystem( this ).parent().find( ".ao-accordion .answer_comment_text" ).val() ];
					})
